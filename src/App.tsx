...
function RevealLayer({ image, cursorX, cursorY }: RevealLayerProps) {
  // A canvas drawn each frame and applied via toDataURL() hard-freezes
  // Chrome's renderer; the same soft circle as a CSS radial-gradient mask
  // is visually identical and updates cheaply.
